    ...
    def student_form_popup(self, student_data=None):
        ...
        def luu():
            ...
            if is_edit:
                ...
                self.hs.update("ma_hs", student_data["ma_hs"], updated_info)
        ...
        pop.bind("<Return>", lambda e: luu())
        btn_text = "Cập nhật thông tin" if is_edit else "Lưu thông tin"
        tk.Button(pop, text=btn_text, bg=self.color_navy, fg="white", font=("Arial", 10, "bold"), command=luu, pady=8, padx=20).pack(pady=20)
