...
class LoginView:
    def __init__(self, master, app_manager):
        ...
        # 1. Cấu hình để khung cha (master) có thể co giãn
    ...
    def view(self):
        # 2. Thay vì place(), dùng grid để đưa frame vào giữa
        ...
        # Grid giúp frame căn giữa tuyệt đối và co giãn theo
        self.frame_login.grid(row=0, column=0)

        # Để các phần tử bên trong frame co giãn theo chiều ngang:
        self.frame_login.grid_columnconfigure(0, weight=1)

        # LOGO
        img = Image.open("assets/logo.png")
        # CustomTkinter hỗ trợ Image tốt hơn qua ctk.CTkImage nếu cần,
        # nhưng ở đây dùng PIL kết hợp ctk.CTkLabel vẫn ổn.
        ...
        # USERNAME
        ctk.CTkLabel(self.frame_login, text="Username", text_color="black", font=("Arial", 12)).pack(fill="x",
                                                                                                       padx=40)
        ...
        # PASSWORD
        ctk.CTkLabel(self.frame_login, text="Password", text_color="black", font=("Arial", 12)).pack(fill="x",
                                                                                                       padx=40)
